...
d = []
d.append(['label1','label2',['/eos/cms/store/user/atishelm/HH_MC/gridpack_test/test2/','root://cms-xrd-global.cern.ch//store/user/atishelm/HH_MC/gridpack_test/test2/'],kMagenta,kMagenta-10])
...
vs.append(['invm',200,200,400]) # Invariant mass
